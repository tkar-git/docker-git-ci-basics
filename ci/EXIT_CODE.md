...
# LISCENCE
This lesson is built on a framework developed by Software Carpentry. Their license can be found [here](https://github.com/hsf-training/hsf-training-cicd-github/blob/gh-pages/LICENSE.md)
